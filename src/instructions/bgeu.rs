...
fn instruction_parsing() {
    // imm[12|10:5] | rs2[24:20] | rs1[19:15] | 111 | imm[4:1|11] | 11000 | 11
    ...
    let rv32: u32 = encode_1100011(imm_11, imm_7, imm_3, rs2, rs1, 0b111);
    assert_eq!(rv32, 0xeed4f963);
