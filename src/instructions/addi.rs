...
impl Arithmetic for Addi {
    fn apply(&self, imm: &[u8; 8], x_rs1: &[u8; 8], _x_rs2: &[u8; 8]) -> [u8; 8] {
        ...
        decomp(x_rs1_u32.wrapping_add(imm_u32))
    }
}
...
fn instruction_parsing() {
    // imm[31:20] | rs1[19:15] | 000 | rd[11:7] | 0010011
    ...
    //let imm_decomp: [u8; 8] = [0b1000, 0b1001, 0b1010, 0, 0, 0, 0, 0];
