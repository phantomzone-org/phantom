...
pub fn trace_inv<A: VecZnxCommon, B: VecZnxCommon>(
    module: &Module,
    log_base2k: usize,
    step_start: usize,
    step_end: usize,
...
pub fn trace_inplace<A: VecZnxCommon>(
    module: &Module,
    log_base2k: usize,
    step_start: usize,
    step_end: usize,
...
pub fn trace_inplace_inv<A: VecZnxCommon>(
    ...
    let mut tmp_a: VecZnxBorrow = VecZnxBorrow::from_bytes(module.n(), a_cols, tmp_bytes_vec_znx);
    tmp_a.copy_from(a);
    trace_inplace_core(module, log_base2k, step_start, step_end, a, tmp_bytes);
