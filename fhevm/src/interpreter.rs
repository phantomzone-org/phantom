...
impl Interpreter {
    pub fn new(module: &Module, max_counter: usize, max_address: usize, max_pc: usize) -> Self {
        ...
        Self {
            ...
            imm_27: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            imm_23: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            imm_19: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            imm_15: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            imm_11: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            imm_7: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            imm_3: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            rs1: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            rs2: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            rd_w: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            mem_w: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
            pc_w: Memory::new(module, LOGBASE2K, LIMBS, MAXOPSADDRESS),
