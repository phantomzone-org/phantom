...
pub fn a_apply_trace_into_a<const INV: bool, const NTT: bool>(
    ...
    if log_steps > 0 {
        ...
        if INV {
            ...
            trace_core::<NTT>(ring, step_start, trace_gal_els, auto_perms, buf0, buf1);
            ring.a_sub_b_into_a::<1, ONCE>(buf1, a);
        } else {
            ring.a_mul_b_scalar_barrett_into_a::<ONCE>(&n_inv, a);
            trace_core::<NTT>(ring, step_start, trace_gal_els, auto_perms, buf0, a);
        }
    }
}
...
pub fn a_apply_trace_into_b<const INV: bool, const NTT: bool>(
    ...
    if log_steps > 0 {
        ...
        if INV {
            ...
            trace_core::<NTT>(ring, step_start, trace_gal_els, auto_perms, buf0, b);
        }
    } else {
        b.copy_from(a);
    }
