...
This example contains a minimal template for a Phantom program. For more advanced examples, check out the [otc](../otc/README.md) example.
...
- [ ] Run `cargo run --release` in this directory to run Phantom.
